...
sys.path.append(os.path.abspath("/mnt/sdd/baijiaxin/foundation_model/scripts/tasks"))
...
# Local Dependencies
import downstream.HIPT_4K.vision_transformer as vits
import downstream.HIPT_4K.vision_transformer4k as vits4k
from downstream.HIPT_4K.hipt_heatmap_utils import *
from downstream.HIPT_4K.hipt_model_utils import get_vit256, get_vit4k, tensorbatch2im, eval_transforms, roll_batch2img
