...
def init_args():
    parser = argparse.ArgumentParser(description="LBC_retrieval")
    ...
    parser.add_argument("--key_feature_path", type=str, default="../../data/instance_classification_feature/LBC", help="save freeze backbone feature")
    parser.add_argument("--query_feature_path", type=str, default="../../data/instance_classification_feature/LBC_test", help="save freeze backbone feature")
    parser.add_argument("--save_path", type=str, default="../../data/instance_retrieval_output/LBC", help="save model parameters, test results and logs")

    parser.add_argument("--device", type=int, default=3, help="device index")
    parser.add_argument("--seed", type=int, default=None, help="random seed")  # 80, 42, 52, 62, 72
