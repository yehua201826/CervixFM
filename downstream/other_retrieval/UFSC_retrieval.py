...
def init_args():
    parser = argparse.ArgumentParser(description="UFSC_retrieval")

    parser.add_argument("--model", type=str, default="ViT_classifier", help="model name")

    parser.add_argument("--data_path", type=str, default="../../data/other_classification_dataset_224/UFSC", help="UFSC dataset path")
    parser.add_argument("--key_feature_path", type=str, default="../../data/other_classification_feature/UFSC", help="save freeze backbone feature")
    parser.add_argument("--query_feature_path", type=str, default="../../data/other_classification_feature/UFSC_test", help="save freeze backbone feature")
    parser.add_argument("--save_path", type=str, default="../../data/other_retrieval_output/UFSC", help="save model parameters, test results and logs")
