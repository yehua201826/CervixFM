...
def init_args():
    parser = argparse.ArgumentParser(description="LBC_train")
    ...
    parser.add_argument("--feature_path", type=str, default="../../data/instance_classification_feature/LBC", help="save freeze backbone feature")
...
if __name__=="__main__":
    ...
    train_dataset = Instance_Dataset(data_path=args.data_path,  efficiency=args.label_efficiency, train=True, seed=args.seed)

    model = eval(args.model)(pretrained_path=args.pretrained_path, num_class=args.num_class, patch_size=args.patch_size, patch_resize=args.patch_resize, stride=args.stride, ViT_freeze=args.ViT_freeze)
